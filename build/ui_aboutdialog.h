...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DGCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>DGCoin</b> version", 0));
...
"Copyright \302\251 2016 The DGCoin developers", 0));
