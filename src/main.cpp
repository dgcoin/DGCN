...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DGCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DGCoin 2016 latest altcoin to hit the block.";
        CTransaction txNew;
        txNew.nTime = 1458582550;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1458582550;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 835556;

	
        assert(block.hashMerkleRoot == uint256("0x760587ae9380cf1b7f1308ec9e70cc527a4533c3721119633b81b39a2441555a"));
